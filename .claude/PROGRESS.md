...
> 마지막 갱신: 2026-07-14 (위기 프로토콜 재설계: 사랑 대전제 + 응답 완화·학대 분기, D-018)
...
> 반영 현황(2026-07-14, D-018): 아래 중 **의도 분류 프롬프트(수정안 3건 포함)·'사랑' 대전제
> (master.txt/CLAUDE.md)·위기 응답 완화 + 학대 분기**는 민규 승인·워킹트리 반영·테스트 78건 통과
> 완료. 신규 프롬프트 5건·위기 감지 패턴·학대 전용 문구/데이터 정책·환각 폴백 문구는 여전히 대기.
