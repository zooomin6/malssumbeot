...
**현재 상태 (2026-07-23, 실제 코드 기준)**
코어 파이프라인 + 채팅 HTTP 계층 + 소셜 로그인/JWT 인증 완성, 단위·통합 테스트 108건. 푸시,
QA 자동러너, 모바일 앱은 아직 미구현.
...
다음은 Phase 3(모바일 앱). RN 담당자 = 직접 개발 확정(D-027). MVP 목표는 RN 앱(D-002).
